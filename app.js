...
const ALLOWED_IPS = (process.env.ALLOWED_IPS || '186.102.90.66,186.102.86.56,186.102.77.146,190.61.45.230,192.168.10.23,192.168.10.1,186.102.62.30,186.102.55.56')
  .split(',')
  .map(ip => ip.trim())
  .filter(Boolean);
